  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(onTap: () =>Navigator.push(context,MaterialPageRoute(builder: ((context) => detalle(idCliente: documentSnapshot.id,)))),
                        title: Text(documentSnapshot['nombre'].toString()+"\t"+documentSnapshot['apellido'].toString()),
       ...
       floatingActionButton: FloatingActionButton(child:Icon(Icons.person_add) , onPressed: () {
